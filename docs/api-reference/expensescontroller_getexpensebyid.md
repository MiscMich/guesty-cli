...
Returns expense details including current version (amount, status, dates) and attachments.
...
```json
{
  ...
  "paths": {
    "/expenses-api/expenses/{id}": {
      "get": {
        "operationId": "ExpensesController_getExpenseById",
        ...
        "responses": {
          "200": {
            "description": "Expense details wrapped in a data property",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
