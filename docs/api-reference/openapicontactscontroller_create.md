...
```json
{
  ...
  "paths": {
    "/contacts": {
      "post": {
        "operationId": "OpenApiContactsController_create",
        "summary": "Create a new contact",
        "description": "Creates a new contact in the phonebook with the provided information.",
        "parameters": [],
        "requestBody": {
          "required": true,
          "description": "Contact information to be created.",
          "content": {
            "application/json": {
              "schema": {
                "type": "object",
