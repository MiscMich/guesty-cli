...
```json
{
  ...
  "paths": {
    "/expenses-api/expenses/{id}/cancel": {
      "post": {
        "operationId": "ExpensesController_cancelExpense",
        "summary": "Cancel expense",
        "description": "Cancels an expense by its ID.\n\nSets the expense status to CANCELED, deletes all associated Journal Entries.\n\nSupports cancellation of expenses in SCHEDULED, SUBMITTED, or INSUFFICIENT_FUNDS status.\nRejects cancellation for PAID or already CANCELED expenses.\nRejects cancellation when any associated Journal Entry is locked, reconciled, or disbursed.",
        "tags": [
        ...
        "parameters": [
          {
            ...
            "required": true,
            "in": "path",
            "description": "Expense ID (UUID) to cancel",
            "schema": {
        ...
        "responses": {
          "200": {
            "description": "Expense successfully canceled"
          },
          "401": {
          ...
          "409": {
            "description": "Expense cannot be canceled - already processed, canceled, or has locked charges",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
