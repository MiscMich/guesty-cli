...
Use this request to create a direct booking. **Note:** This endpoint is soon to be deprecated. Please use [this endpoint](https://open-api-docs.guesty.com/reference/reservationsopenapicontroller_quickbooking) instead.
  ...
  "paths": {
    "/reservations": {
      "post": {
        ...
        "description": "Use this request to create a direct booking. **Note:** This endpoint is soon to be deprecated. Please use [this endpoint](https://open-api-docs.guesty.com/reference/reservationsopenapicontroller_quickbooking) instead.",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "money": {
                    ...
                    "properties": {
                      ...
                      "currency": {
                        "type": "string",
                        "description": "Currency must match the currency of the property",
                        "example": "USD"
                      }
                    },
                    "required": [
