...
```json
{
  ...
  "paths": {
    "/rm-promotions/promotions/{promotionId}/listings": {
      "get": {
        "operationId": "PromotionController_getAssignedListingIds",
        "summary": "Get promotion listings",
        "description": "Get listing IDs assigned to a promotion.",
        "parameters": [
          {
            "name": "promotionId",
            "required": true,
          ...
          },
          {
            ...
            "required": true,
            "in": "query",
            "description": "Include children listings.",
            "schema": {
              "default": false,
              "example": true,
              "type": "boolean"
        ...
        "responses": {
          "200": {
            "description": "Returns listing IDs assigned to the promotion.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                  "properties": {
                    ...
                    "listingIds": {
                      "description": "Listing IDs assigned to the promotion.",
                      "example": [
                        "63ee4b7e459ca31532f",
                        "63ee4b7e459ca31532f"
                      ],
                    ...
                    "count": {
                      "type": "number",
                      "description": "Number of listings in the result set.",
                      "example": 10
                    },
                    "requestId": {
                      "type": "string",
