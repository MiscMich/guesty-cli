  ...
  "paths": {
    "/business-models-api/transactions/expenses": {
      "post": {
        ...
        "description": "Create expense for provided vendor. The expense will be created only for the specified owner and will not be split between all the listing ownerships.",
        "tags": [
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  "name": {
                    "type": "string",
                    "description": "Expense name. Max length is 255 characters",
