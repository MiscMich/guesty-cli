...
Create a new guest for an owner and update the owner guestId
...
```json
{
  ...
  "paths": {
    "/owners/{ownerId}/guest": {
      "post": {
        "operationId": "OwnersOpenApiController_createOwnerGuest",
        "summary": "Create owner guest",
        "description": "Create a new guest for an owner and update the owner guestId",
        "parameters": [
          {
            "name": "ownerId",
            "required": true,
