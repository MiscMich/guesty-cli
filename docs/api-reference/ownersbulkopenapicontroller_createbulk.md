# Create multiple owners with assigned listings
...
```json
{
  ...
  "paths": {
    "/owners/bulk": {
      "post": {
        "operationId": "OwnersBulkOpenApiController_createBulk",
        "summary": "Create multiple owners with assigned listings",
        "description": "Create multiple owners with assigned listings",
        "parameters": [],
        "requestBody": {
          "required": true,
          "content": {
