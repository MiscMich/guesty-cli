...
```json
{
  ...
  "paths": {
    "/properties-api/custom-fields/{propertyId}": {
      "put": {
        "operationId": "updateMany",
        "summary": "Update property Custom Fields",
        "description": "Update many custom fields of property at once. It will only update custom fields of property, if You need to remove other fields please use DELETE endpoint",
        "tags": [
          "Custom Fields"
        ],
        "parameters": [
