  ...
  "paths": {
    "/rm-promotions/promotions/{promotionId}/unassign": {
      "put": {
        ...
        "summary": "Unassign Properties from a Promotion.",
        "description": "Removes properties from participating in the promotion.",
        "parameters": [
          {
            "name": "promotionId",
            "required": true,
        ...
        "responses": {
          "202": {
            "description": "Request for unassigning listings from the promotion has been accepted and is being processed.",
            "content": {
              "application/json": {
                "schema": {
                  "type": "object",
                  "properties": {
                    ...
                    "unassignedListingIds": {
                      "description": "Unassigned listings in this request.",
                      "example": [
                        "63ee4b7e459ca31532f",
                        "63ee4b7e459ca31532f"
                      ],
